...
row_conditions=['Normal', 'Normal', 'Normal', 'Normal']

# Left-Right Media Conditions
left_right_media_condition=['Alga Gro','Alga Gro']
...
df_mean_Vnum.to_csv(subfolder_path+'Average_Volvox_numbers_all_cameras_new.csv')